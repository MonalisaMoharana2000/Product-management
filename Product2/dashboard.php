<?php
// if you are log in then you can enter othrewise redirect to the login system
session_start();
			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Last Login : <?php echo date("Y-d-m"); ?></p>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body" style="background-color:#245580">
